    ...
    return (
        <div className="min-h-screen bg-white pt-20">
            ...
            <section className="relative h-[60vh] flex items-center overflow-hidden">
                <img src={IMAGES.about_hero} alt="About PURE GOLD Products" className="absolute inset-0 w-full h-full object-cover" />
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <h1 className="font-serif text-5xl lg:text-7xl font-bold text-white leading-tight">
                            The Heart Behind<br /><span className="text-gold-400">PURE GOLD Products</span>
                        </h1>
                    </motion.div>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
                        <motion.div initial={{ opacity: 0, x: -40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.8 }}>
                            ...
                            <div className="space-y-4 text-gray-600 leading-relaxed">
                                <p>PURE GOLD Products was born from a simple but powerful conviction: that the world deserves to experience <strong>true</strong> Ceylon cinnamon — not the cassia imitation sold under the same name in most grocery stores.</p>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="order-1 lg:order-2">
                            ...
                            <div className="space-y-4 text-gray-600 leading-relaxed">
                                ...
                                <p>At PURE GOLD Products, we pay our partner chalias fairly and directly — no middlemen, no exploitation. Their welfare and the sustainability of their craft are inseparable from our own success.</p>
                                <p>When you choose PURE GOLD Products, you choose to support these remarkable people and their way of life.</p>
                            </div>
                        </div>
                    </div>
                </div>
